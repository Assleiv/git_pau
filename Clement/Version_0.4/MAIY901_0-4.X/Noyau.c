...
int CompteurIT=0;
unsigned char IdxCurLectRxGSM_IT_Rep;
unsigned char IdxCurRxGSM_IT;
// </editor-fold>
...
{// <editor-fold defaultstate="collapsed" desc="">
    ...
    {
        if(TimeOutGSM_T1) TimeOutGSM_T1--;
...
{// <editor-fold defaultstate="collapsed" desc="">
    //if (IEC0bits.U1RXIE == 1 && IFS0bits.U1RXIF == 1) revoir la condition
    {
...
//init du microcontrôleur
    ...
    // Init des variables de lectures
    IdxCurRxGSM_IT=0;
    IdxCurLectRxGSM_IT_Rep=0;
    LgnLigneGSM=0;
//séquenceur
    ...
    while (1)
    {
        ...
        while(IdxCurLectRxGSM_IT_Rep!=IdxCurRxGSM_IT)
      {
      ReceptionCaractereGSM(CurRxGSM_IT[IdxCurLectRxGSM_IT_Rep]);
      U2TXREG=CurRxGSM_IT[IdxCurLectRxGSM_IT_Rep]; // espion test
      IdxCurLectRxGSM_IT_Rep++;
      
//      IdxCurLectRxGSM_IT_Rep&=0x7f;
      }
...
void Init_Tasks(void)    //Configuration parametres taches au demarrage
{
	...
	TASK[TASK1_ID].STATE=READY;TASK[TASK1_ID].DELAY=0;TASK[TASK1_ID].STEP=0;TASK[TASK1_ID].PHASE=AMBRION;
    ...
    TASK[TASK5_ID].STATE=READY;TASK[TASK5_ID].DELAY=0;TASK[TASK5_ID].STEP=0;TASK[TASK5_ID].PHASE=AMBRION;
    TASK[TASK6_ID].STATE=HALTE;TASK[TASK6_ID].DELAY=0;TASK[TASK6_ID].STEP=0;TASK[TASK6_ID].PHASE=AMBRION;
