...
//------------------------------------INIT--------------------------------------
        ...
        { 
            ...
            I2C_writeBuffer[5]='u';
            I2C_writeBuffer[6]='r';
            //I2C_DATA = 55;  //juste pour vérifier que l'écriture/lecture fonctionne, (à retirer par la suite)
        ...
        case 3:
        {
            /*I2C_writeBuffer2[0]=UCharBcdToUChar(32);
            I2C_writeBuffer2[1]=UCharBcdToUChar(48);
            I2C_writeBuffer2[2]=UCharBcdToUChar(21);
            I2C_writeBuffer2[3]=UCharBcdToUChar(17);
            I2C_writeBuffer2[4]=UCharBcdToUChar(2);
            I2C_writeBuffer2[5]=UCharBcdToUChar(5);
            I2C_writeBuffer2[6]=UCharBcdToUChar(19);*/
            Date.An=19;
            Date.Mois=5;
            Date.Jour=17;
            Date.wd=2;
...
unsigned char IdleI2c(volatile unsigned int* TOut)
{
...
unsigned char SendStartI2c(volatile unsigned int* TOut)
{
    if(IdleI2c(TOut)==1)
    {
        return 1;
...
unsigned char SendAckI2c(unsigned char ack, volatile unsigned int* TOut)
{
    if(IdleI2c(TOut)==1)
    {
        return 1;
...
unsigned char SendNackI2c(volatile unsigned int* TOut)
{
    if(IdleI2c(TOut)==1)
    {
        return 1;
...
unsigned char SendRestartI2c(volatile unsigned int* TOut)
{
    if(IdleI2c(TOut)==1)
    {
        return 1;
...
unsigned char SendAddI2c(unsigned char adresseSlave, unsigned char read_nwrite, volatile unsigned int* TOut)
{
char Trace[50];
unsigned char Ret;
...
unsigned char SendOctetI2c(unsigned char octet, volatile unsigned int* TOut)
{
    if(IdleI2c(TOut)==1)
    {
        return 1;
...
unsigned char SendStopI2c(volatile unsigned int* TOut)
{
    if(IdleI2c(TOut)==1)
    {
        return 1;
...
unsigned char AckI2cRecu(volatile unsigned int* TOut)
{
    if(IdleI2c(TOut)==1)
    {
        return 1;
...
unsigned char MasterI2cReceiver(volatile unsigned int* TOut)
{
    if(IdleI2c(TOut)==1)
    {
        return 1;
...
unsigned char UCharBcdToUChar(unsigned char UcBcd)
{
...
unsigned char LectureRegistres_8563(unsigned char Adresse, unsigned char *DataRTC,unsigned char NbOctet)
{
...
unsigned char LectureDateHeure(struct STR_DATE *pt)
{
...
unsigned char EcritureRegistres_8563(unsigned char Adresse, unsigned char *DataRTC,unsigned char NbOctet)
{
unsigned char EESlaveAddr;
...
unsigned char EcritureDateHeure(struct STR_DATE *pt)
{
unsigned char DataRTC[7];
...
unsigned char UCharToUCharBcd(unsigned char Uc)
{
unsigned char Retour;
...
unsigned char ReturnError(unsigned char* CodeErreur)
{
    switch (CodeErreur)
    {
        case 1:
